(function () {
    ...
    var approveVacancyController = function (approveVacancyService, WizardHandler, uiGridConstants, $filter, $timeout, $location) {
        var vm = this;
        vm.filterPost = null;
        vm.filterTitle = null;
        vm.isLoading = true;
        ...
        vm.initialisePage = function () {
            vm.isLoading = true;
            approveVacancyService.getSalaries().then(function (response) {
                vm.salaries = response.data;
                if (response.data != null) { }
            }, function (error) {
                console.log(JSON.stringify(error));
            });
            approveVacancyService.getCapturedVacancies().then(function (response) {
        ...
        vm.approve = function (vacancy) {
            ...
            if (vm.validate(vacancy)) {
                ...
                approveVacancyService.approveVacancy(vacancy).then(function (response) {
        ...
        vm.reject = function (vacancy) {
            ...
            approveVacancyService.rejectVacancy(vacancy).then(function (response) {
                vm.initialisePage();
                WizardHandler.wizard().previous();
            }, function (error) {
                console.log(JSON.stringify(error));
        ...
        vm.getAllQuestionsAndAnswers = function (vacancy) {
            ...
            approveVacancyService.getGenericQuestions().then(function (response) {
                // console.log("successfully called: vacancyService.getVacancyStatuses()" + response.data);
                vm.genericQuestionsDB = response.data;
            });

            approveVacancyService.getAllQuestionsAndAnswers(vacancy).then(function (response) {
        ...
        vm.removeGenericAnswers = function (item, items) {
            ...
            approveVacancyService.deleteAnswerGenericQuestion(item).then(function (response) {
        ...
        vm.removeSpecificAnswers = function (item, items) {
            ...
            approveVacancyService.deleteAnswerSpecificQuestion(item).then(function (response) {
                console.log(response);
            });
        };
        ...
        vm.removeGenericQuestion = function (item, items) {
            ...
            approveVacancyService.deleteGenericQuestion(question).then(function (response) {
                console.log(response);
            });
        };
        ...
        vm.removeSpecificQuestion = function (item, items) {
            ...
            approveVacancyService.deleteSpecificQuestion(question).then(function (response) {
                console.log(response);
            });
        };
        ...
        vm.updateQuestions = function (vacancy) {
            ...
            if (vm.listAnswersGenericQuestion.length > 0) {
                approveVacancyService.updateAnswerGenericQuestion(vm.listAnswersGenericQuestion);
            }
            ...
            if (listSpecificQuestionsAnswers.length > 0) {
                ...
                approveVacancyService.updateSpecificQuestions(listSpecificQuestionsAnswers).then(function (response) {
                    console.log(response);
                });
            }
        }
    };
    angular.module('eRecruitmentApp').controller('approveVacancyController', approveVacancyController);
    approveVacancyController.$inject = ['approveVacancyService', 'WizardHandler', 'uiGridConstants', '$filter', '$timeout', '$location'];
})();