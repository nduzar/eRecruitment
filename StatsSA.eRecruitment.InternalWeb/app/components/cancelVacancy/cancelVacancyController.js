(function () {
    ...
    var cancelVacancyController = function (cancelVacancyService, WizardHandler, $filter, $timeout, $location) {
        var vm = this;
        vm.canEdit = false;
    ...
    cancelVacancyController.$inject = ['cancelVacancyService', 'WizardHandler', '$filter', '$timeout', '$location'];
})();