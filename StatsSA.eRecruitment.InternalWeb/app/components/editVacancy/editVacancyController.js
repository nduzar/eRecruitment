(function () {
    ...
    var editVacancyController = function (editVacancyService, WizardHandler, uiGridConstants, $filter , $timeout, $location) {
        var vm = this;
        vm.isLoading = true;
        vm.noRecords = false;
        vm.filterPost = null;
        ...
        vm.updateNotch = function (selectedSalary) {
            ...
            if (selectedSalary.salaryLevel >= 11 && selectedSalary.salaryLevel <= 16) {
                vm.selectedVacancy.remunerationDescription = "per annum (All-Incl.)";
            }
            else {
    ...
    editVacancyController.$inject = ['editVacancyService', 'WizardHandler', 'uiGridConstants', '$filter', '$timeout', '$location'];
})();