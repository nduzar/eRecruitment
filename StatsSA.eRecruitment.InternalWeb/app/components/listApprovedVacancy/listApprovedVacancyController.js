(function () {
    ...
    var listApprovedVacancyController = function (listApprovedVacancyService, WizardHandler, uiGridConstants, $filter, $timeout, $location) {
        var vm = this;
        vm.filterPost = null;
        vm.filterTitle = null;
        vm.isLoading = true;
        ...
        vm.initialisePage = function () {
            vm.isLoading = true;
            listApprovedVacancyService.getSalaries().then(function (response) {
                vm.salaries = response.data;
                if (response.data != null) { }
            }, function (error) {
                console.log(JSON.stringify(error));
            });
            listApprovedVacancyService.getApprovedList().then(function (response) {
        ...
        vm.approve = function (vacancy) {
            ...
            if (vm.validate(vacancy)) {
                ...
                listApprovedVacancyService.approveVacancy(vacancy).then(function (response) {
        ...
        vm.reject = function (vacancy) {
            ...
            listApprovedVacancyService.rejectVacancy(vacancy).then(function (response) {
                vm.initialisePage();
                WizardHandler.wizard().previous();
            }, function (error) {
                console.log(JSON.stringify(error));
        ...
        vm.getAllQuestionsAndAnswers = function (vacancy) {
            ...
            listApprovedVacancyService.getGenericQuestions().then(function (response) {
                // console.log("successfully called: vacancyService.getVacancyStatuses()" + response.data);
                vm.genericQuestionsDB = response.data;
            });

            listApprovedVacancyService.getAllQuestionsAndAnswers(vacancy).then(function (response) {
        ...
        vm.removeGenericAnswers = function (item, items) {
            ...
            listApprovedVacancyService.deleteAnswerGenericQuestion(item).then(function (response) {
        ...
        vm.removeSpecificAnswers = function (item, items) {
            ...
            listApprovedVacancyService.deleteAnswerSpecificQuestion(item).then(function (response) {
                console.log(response);
            });
        };
        ...
        vm.removeGenericQuestion = function (item, items) {
            ...
            listApprovedVacancyService.deleteGenericQuestion(question).then(function (response) {
                console.log(response);
            });
        };
        ...
        vm.removeSpecificQuestion = function (item, items) {
            ...
            listApprovedVacancyService.deleteSpecificQuestion(question).then(function (response) {
                console.log(response);
            });
        };
        ...
        vm.updateQuestions = function (vacancy) {
            ...
            if (vm.listAnswersGenericQuestion.length > 0) {
                listApprovedVacancyService.updateAnswerGenericQuestion(vm.listAnswersGenericQuestion);
            }
            ...
            if (listSpecificQuestionsAnswers.length > 0) {
                ...
                listApprovedVacancyService.updateSpecificQuestions(listSpecificQuestionsAnswers).then(function (response) {
                    console.log(response);
                });
            }
        }
    };
    angular.module('eRecruitmentApp').controller('listApprovedVacancyController', listApprovedVacancyController);
    listApprovedVacancyController.$inject = ['listApprovedVacancyService', 'WizardHandler', 'uiGridConstants', '$filter', '$timeout', '$location'];
})();