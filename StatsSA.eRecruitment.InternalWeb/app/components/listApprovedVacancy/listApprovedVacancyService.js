(function () {
    ...
    var listApprovedVacancyService = function ($http, $q, ngConfigSettings) {
    ...
    angular.module('eRecruitmentApp').factory('listApprovedVacancyService', listApprovedVacancyService);
    listApprovedVacancyService.$inject = ['$http', '$q', 'ngConfigSettings'];
})();