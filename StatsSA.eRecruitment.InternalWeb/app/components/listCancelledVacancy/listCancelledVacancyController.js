(function () {
    ...
    var listCancelledVacancyController = function (listCancelledVacancyService, WizardHandler, uiGridConstants, $filter, $timeout, $location) {
        var vm = this;
        vm.filterPost = null;
        vm.filterTitle = null;
        vm.isLoading = true;
        ...
        vm.initialisePage = function () {
            vm.isLoading = true;
            listCancelledVacancyService.getSalaries().then(function (response) {
                vm.salaries = response.data;
                if (response.data != null) { }
            }, function (error) {
                console.log(JSON.stringify(error));
            });
            listCancelledVacancyService.getcancelledList().then(function (response) {
        ...
        vm.approve = function (vacancy) {
            ...
            if (vm.validate(vacancy)) {
                ...
                listCancelledVacancyService.approveVacancy(vacancy).then(function (response) {
                    vm.updateQuestions(vacancy);
                    vm.initialisePage();
                    vm.hideConfirmReason = true;
                    vm.ShowSuccess = true;
                    vm.SuccessMessage = "vacancy successfully approved!";
                    //WizardHandler.wizard().previous();
        ...
        vm.reject = function (vacancy) {
            ...
            listCancelledVacancyService.rejectVacancy(vacancy).then(function (response) {
                vm.initialisePage();
                WizardHandler.wizard().previous();
            }, function (error) {
                console.log(JSON.stringify(error));
        ...
        vm.getAllQuestionsAndAnswers = function (vacancy) {
            ...
            listCancelledVacancyService.getGenericQuestions().then(function (response) {
                // console.log("successfully called: vacancyService.getVacancyStatuses()" + response.data);
                vm.genericQuestionsDB = response.data;
            });

            listCancelledVacancyService.getAllQuestionsAndAnswers(vacancy).then(function (response) {
        ...
        vm.removeGenericAnswers = function (item, items) {
            ...
            listCancelledVacancyService.deleteAnswerGenericQuestion(item).then(function (response) {
        ...
        vm.removeSpecificAnswers = function (item, items) {
            ...
            listCancelledVacancyService.deleteAnswerSpecificQuestion(item).then(function (response) {
                console.log(response);
            });
        };
        ...
        vm.removeGenericQuestion = function (item, items) {
            ...
            listCancelledVacancyService.deleteGenericQuestion(question).then(function (response) {
                console.log(response);
            });
        };
        ...
        vm.removeSpecificQuestion = function (item, items) {
            ...
            listCancelledVacancyService.deleteSpecificQuestion(question).then(function (response) {
                console.log(response);
            });
        };
        ...
        vm.updateQuestions = function (vacancy) {
            ...
            if (vm.listAnswersGenericQuestion.length > 0) {
                listCancelledVacancyService.updateAnswerGenericQuestion(vm.listAnswersGenericQuestion);
            }
            ...
            if (listSpecificQuestionsAnswers.length > 0) {
                ...
                listCancelledVacancyService.updateSpecificQuestions(listSpecificQuestionsAnswers).then(function (response) {
                    console.log(response);
                });
            }
        }
    };
    angular.module('eRecruitmentApp').controller('listCancelledVacancyController', listCancelledVacancyController);
    listCancelledVacancyController.$inject = ['listCancelledVacancyService', 'WizardHandler', 'uiGridConstants', '$filter', '$timeout', '$location'];
})();