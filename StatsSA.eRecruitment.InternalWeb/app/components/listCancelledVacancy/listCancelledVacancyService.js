(function () {
    ...
    var listCancelledVacancyService = function ($http, $q, ngConfigSettings) {
    ...
    angular.module('eRecruitmentApp').factory('listCancelledVacancyService', listCancelledVacancyService);
    listCancelledVacancyService.$inject = ['$http', '$q', 'ngConfigSettings'];
})();