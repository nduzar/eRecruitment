(function () {
    ...
    var usersController = function (usersService, WizardHandler, $filter, $timeout, $location) {
        var vm = this;
        vm.editMode = true;
        vm.isCollapsed = true;
        ...
        vm.updateUser = function (user) {
            ...
            usersService.updateUser(user).then(function (response) {
                if (response.data.status) {
                    ...
                    //vm.thisUsersRoles = [];
                    vm.ShowSuccess = true;
                    vm.SuccessMessage = "user successfully updating!";
                    //vm.viewUser(vw.viewedUser);
        ...
        vm.insertUser = function (user) {
            ...
            if (vm.thisUsersRoles.length == 0) {
                ...
                var newUser = {
                    ...
                    fullName: vm.viewedUser.fullName,
                    email: vm.viewedUser.email,
                ...
                usersService.insertUser(newUser).then(function (response) {
                    if (response.data.status) {
                        ...
                        vm.initialisePage();
                        vm.ShowSuccess = true;
                        vm.SuccessMessage = "user successfully added!";
                        //WizardHandler.wizard().previous();
    ...
    usersController.$inject = ['usersService', 'WizardHandler', '$filter', '$timeout', '$location'];
})();