...
namespace StatsSA.eRecruitment.InternalWeb.Controllers
{
    ...
    public class InternalVacancyController : ApiController
    {
        ...
        public IHttpActionResult CancelVacancy(Vacancy objVacancy)
        {
            ...
            SentEmailAll(subject, emailContent);
        ...
        public IHttpActionResult AddVacancy(Vacancy vacancy)
        {
            ...
            try
            {
                string subject = "Vacancy captured: " + vacancy.JobTitle; ;
        ...
        public IHttpActionResult ApproveVacancy(Vacancy objVacancy)
        {
            try
            {
                string subject = "Vacancy approved: " + objVacancy.JobTitle;
        ...
        //{
        //    AllQuestionsAndAnswers allQuestionsAndAnswers = new AllQuestionsAndAnswers();
        //    if (vacancy != null)
        //    {
        ...
        private void SentEmailAll(string subject, string emailContent)
        {
            try
            {
