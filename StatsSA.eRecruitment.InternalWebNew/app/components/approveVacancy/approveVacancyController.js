(function () {
    ...
    var approveVacancyController = function (approveVacancyService, WizardHandler, uiGridConstants, $filter) {
        var vm = this;
        vm.filterPost = null;
        vm.filterTitle = null;
        vm.isLoading = true;
    ...
    approveVacancyController.$inject = ['approveVacancyService', 'WizardHandler', 'uiGridConstants', '$filter'];
})();