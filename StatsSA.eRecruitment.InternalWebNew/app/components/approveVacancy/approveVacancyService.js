(function () {
    ...
    var approveVacancyService = function ($http, $q, ngConfigSettings) {
    ...
    angular.module('eRecruitmentApp').factory('approveVacancyService', approveVacancyService);
    approveVacancyService.$inject = ['$http', '$q', 'ngConfigSettings'];
})();