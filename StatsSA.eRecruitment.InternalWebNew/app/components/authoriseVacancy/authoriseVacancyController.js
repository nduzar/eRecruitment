(function () {
    ...
    var authoriseVacancyController = function (authoriseVacancyService, WizardHandler,$filter) {
        var vm = this;
        vm.canEdit = false;
        vm.isLoading = true;
    ...
    authoriseVacancyController.$inject = ['authoriseVacancyService', 'WizardHandler','$filter'];
})();