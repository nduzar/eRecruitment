(function () {
    ...
    var salariesController = function (salariesService, WizardHandler, uiGridConstants, $filter) {
        var vm = this;
        vm.selectedLevel = [];
        vm.salaryModel = [];
        vm.salaries = [];
    ...
    salariesController.$inject = ['salariesService', 'WizardHandler', 'uiGridConstants', '$filter'];
})();