(function () {
    ...
    var vacancyController = function (vacancyService) {
        var vm = this;
           ...
           // console.log("page initialised");
            ...
            vm.updateNotch = function (selectedSalary) {
                if (selectedSalary.salaryLevel >= 11 && selectedSalary.salaryLevel <= 16) {
                    vm.remunerationDescription = "all-inclusive remuneration package per annum";
                }
                else {
        ...
        vm.save = function () {
            ...
            if (vm.vacancy.salary.salaryLevel >= 11 && vm.vacancy.salary.salaryLevel <= 16) {
                vm.vacancy.RemunerationDescription = "all-inclusive remuneration package per annum";
            }
            else
            {
                vm.vacancy.RemunerationDescription = "per annum";
            } 
    ...
    vacancyController.$inject = ['vacancyService'];
})();
