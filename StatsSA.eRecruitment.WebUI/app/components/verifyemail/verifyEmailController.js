(function () {
    ...
    var verifyEmailController = function (verifyEmailService, WizardHandler, $location) {
        var vm = this;
        ...
        vm.searchAccount = function (searchTerms) {
            ...
            verifyEmailService.searchAccount(searchTerms.identityNumber).then(function (response) {
        ...
        {   
            vm.verifyEmailData.captcha = verifyEmailService.generateCaptcha();
        ...
        vm.updateEmailVerification = function () {
            vm.verifyEmailMethod = 'email';
            verifyEmailService.updateEmailVerification(vm.userAccount, vm.verifyEmailMethod).then(function (response) {
                $location.path('/verifyemailrecovery').replace();
            }, function (error) {
    ...
    angular.module('eRecruitmentApp').controller('verifyEmailController', verifyEmailController);
    verifyEmailController.$inject = ['verifyEmailService', 'WizardHandler', '$location'];
